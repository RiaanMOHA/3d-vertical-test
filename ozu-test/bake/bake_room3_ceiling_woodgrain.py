"""
Bake light-colored woodgrain laminate ceiling for room-3.
...
Run on the idle A6000 (GPU 1):
    ...
    CUDA_VISIBLE_DEVICES=1 \\
        ...
        --background \\
        --python ozu-test/bake/bake_room3_ceiling_woodgrain.py

Output (2048^2 each):
    ozu-test/room-3-textures/ceiling/woodgrain_laminate/
